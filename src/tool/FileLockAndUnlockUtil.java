...
public class FileLockAndUnlockUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (flag.indexOf("hello") > 0) {
			...
			// 没有加密
            FileLockAndUnlockUtil.encrypt("D:\\" + filename, "hello");
        }
//		System.out.println(FileLockAndUnlockUtil.decrypt("D:\\"
//                + filename, "D:\\" + filename, 6));
